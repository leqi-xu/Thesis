...
# Added by Xu: Calculate descending sampling probability
...
if __name__ == "__main__":
    ...
    for dataset_name in os.listdir(data_path):
        if dataset_name == 'FB237_64':
            ...
            torch.save(probabilities_tensor, os.path.join(dataset_path, "probabilities_tensor.pt"))
                    
            with open(os.path.join(dataset_path, "ranked_examples.pickle"), "wb") as save_file:
